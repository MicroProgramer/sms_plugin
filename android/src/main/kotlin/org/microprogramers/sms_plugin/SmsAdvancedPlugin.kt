...
class SmsAdvancedPlugin() : FlutterPlugin, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    ...
    this.receiveSmsChannel = EventChannel(flutterPluginBinding.binaryMessenger, "plugins.microprogramers.org/recvSMS", JSONMethodCodec.INSTANCE)

    this.smsStatusChannel = EventChannel(flutterPluginBinding.binaryMessenger, "plugins.microprogramers.org/statusSMS", JSONMethodCodec.INSTANCE)
    ...
    this.queryContactChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "plugins.microprogramers.org/queryContact", JSONMethodCodec.INSTANCE)

    this.queryContactPhotoChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "plugins.microprogramers.org/queryContactPhoto", StandardMethodCodec.INSTANCE)

    this.userProfileChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "plugins.microprogramers.org/userProfile", JSONMethodCodec.INSTANCE)

    this.simCardChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "plugins.microprogramers.org/simCards", JSONMethodCodec.INSTANCE)
