  ...
  factory SmsReceiver() {
    if (_instance == null) {
      const EventChannel eventChannel =
          EventChannel("plugins.microprogramers.org/recvSMS", JSONMethodCodec());
...
class SmsQuery {
  ...
  factory SmsQuery() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel("plugins.microprogramers.org/querySMS", JSONMethodCodec());
...
class SmsRemover {
  static const platform = MethodChannel("microprogramers.sms.remove.channel");
...
class SimCardsProvider {
  ...
  factory SimCardsProvider() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel("plugins.microprogramers.org/simCards", JSONMethodCodec());
